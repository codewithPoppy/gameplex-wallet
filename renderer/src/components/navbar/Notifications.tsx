                ...
                <Menu.Items className="absolute mt-2 right-0 w-[22rem] h-fit p-2 origin-top-right bg-[#1e1e1e] border border-[#383838] divide-y divide-[#383838] rounded-xl shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
                    <div className="px-1 py-1 ">
                        <Menu.Item>
                            {({ active }) => (
                                <button
                                    className={`${active ? 'text-[#fff]' : 'text-white'
                                        } group flex rounded-md items-center w-full px-2 pt-2 pb-0 text-[12px]`}
                                >
                                    <div className="grid grid-cols-2 text-center w-full">
                                        <div className='col-span-2'><img className='w-14 h-14 rounded-xl mx-auto' src="/images/coins/sol.png" alt="" /></div>
                                        <div className='col-span-2'><h1 className='mt-3 text-white text-[16px]'>Approve Transaction</h1></div>
                                        <div className='col-span-2'><h1 className='mt-2 text-[#ffffff99] text-xs'>radium.io</h1></div>
                                        ...
                                        <button className="focus:border-transparent focus:ring-0 w-50 text-black bg-[#02ff63] transition ease-out hover:-translate-y-1 hover:scale-100 delay-150 hover:shadow-lg hover:shadow-[#02ff63cc] font-bold rounded-xl text-sm py-3 px-3 mt-3" type="submit">Approve</button>
                                    </div>
                                </button>
                            )}
                        </Menu.Item>
