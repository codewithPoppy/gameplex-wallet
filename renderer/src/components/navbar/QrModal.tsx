                                    ...
                                    <div className='container mb-5 py-6 px-16'>
                                                ...
                                                show ? (
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className='flex justify-center'>
                                                            <button onClick={onShowScanner} className="focus:outline-none w-64 text-white bg-gradient-to-r from-[#6A00FF] to-[#3C00B7] transition ease-out hover:-translate-y-1 hover:scale-100 delay-150 focus:ring-1 hover:shadow-lg hover:shadow-[#3c00b7cc] font-bold rounded-xl text-sm py-2 px-6 mr-2 my-3" type="submit">Scan QR Code</button>
                                                        </div>
                                                    </div>
                                                )
                                            }
                                        ...
                                        <div className='grid grid-cols-4 bg-[#1e1e1e] border border-[#383838] rounded-xl w-100 mb-2'>
                                            <input 
                                                ...
                                                value={uri} 
                                                type='text' 
                                                className='col-span-3 rounded-xl bg-[#1e1e1e] border-0 text-[#ffffff] text-left text-xs py-4 pl-6'></input>
                                            <div className='flex justify-end rounded-xl'>
                                                <button disabled={!uri} onClick={() => onConnect(uri)} type='button' title="Revoke" className='bg-[#272727] p-3 w-full text-sm rounded-xl text-[#ffffff99]'>
                                                    {loadingUri ? <Spinner color="green" size="sm" /> : 'Connect'}
                                                </button>
                                            </div>
                                        </div>
                                    </div>
