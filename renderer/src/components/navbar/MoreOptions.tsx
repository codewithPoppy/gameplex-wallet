      ...
      {({ open }) => (
        <>
          ...
          >
            <Menu.Items
              static
              className="absolute mt-2 right-0 w-56 p-2 origin-top-right bg-[#1e1e1e] border border-[#383838] divide-y divide-[#383838] rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10"
            >
              ...
              <div className="px-1 py-1">
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      onClick={() =>
                        OptionsModalStore.open("SessionsOptionsModal", {
                          modalHeader: "Sessions",
                        })
                      }
                      className={`${
                        active ? "text-[#99ffa2]" : "text-white"
                    ...
                    >
                      {active ? (
                        <ImLoop className="w-5 h-5 mr-2" aria-hidden="true" />
                      ) : (
                        <ImLoop className="w-5 h-5 mr-2" aria-hidden="true" />
                      )}
                      Sessions
                  ...
                  {({ active }) => (
                    <div className="relative inline-block text-left">
                      <div>
                        <button
                          onClick={() =>
                            OptionsModalStore.open("PairingsOptionsModal", {
                              modalHeader: "Pairings",
                            })
                          }
                          className={`${
                            active ? "text-[#99ffa2]" : "text-white"
