...
import HomeComponent from "../../renderer/src/pages/components/HomeComponent";
export default {
  title: "Page/Home",
  component: HomeComponent,
} as ComponentMeta<typeof HomeComponent>;

const Template: ComponentStory<typeof HomeComponent> = (args) => (
  <HomeComponent {...args} />
);
  ...
  assets: [
    {
      ...
      assetSymbol: "SLIM",
      assetAmount: 1.26,
      assetAmountInUSD: 7241,
      assetPercentChange: 95,
    },
    {
      assetImage:
        "https://raw.githubusercontent.com/solana-labs/token-list/main/assets/mainnet/AATiVPgFBTJejUJrmkwnwH8UTr69CtfodGVCwMvrCa2U/logo.png",
      assetAddress: "AATiVPgFBTJejUJrmkwnwH8UTr69CtfodGVCwMvrCa2U",
      assetName: "Solmanians",
      assetSymbol: "SOLM",
      assetAmount: 382500,
      assetAmountInUSD: 9314,
      assetPercentChange: -15,
    },
    {
      assetImage:
      ...
      assetSymbol: "USDC",
      assetAmount: 0,
      assetAmountInUSD: 5368,
      assetPercentChange: -14,
    },
    {
      assetImage:
      ...
      assetAddress: "2QK9vxydd7WoDwvVFT5JSU8cwE9xmbJSzeqbRESiPGMG",
      assetName: "kekwcoin",
      assetSymbol: "KEKW",
      assetAmount: 100000,
      assetAmountInUSD: 6983,
      assetPercentChange: 54,
    },
    {
      assetImage:
      ...
      assetName: "Dexlab",
      assetSymbol: "DXL",
      assetAmount: 71.914432,
      assetAmountInUSD: 5677,
      assetPercentChange: 94,
    },
  ],
  address: "string",
};
