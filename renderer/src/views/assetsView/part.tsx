            ...
            return (
                <div className="text-right w-full relative">
                    ...
                    <div className="absolute flex w-[40%] h-[30px] top-1/2 left-1/2">
                        <div className={props.index < 5 ? "border-b-[1px] border-[#fff] grow-1 flex-grow" : "border-t-[1px] border-[#fff] grow-1 flex-grow"}></div>
                        <div className={props.index < 5 ? "border-l-[1px] border-white w-[30px]" : "border-l-[1px] border-white w-[30px]"} style={props.index < 5 ? {transform: "skewX(-45deg)", marginLeft: '15px',marginRight: '-15px'} : {transform: "skewX(45deg)", marginLeft: '15px',marginRight: '-15px'}}></div>
                        <div className={props.index < 5 ? "border-t-[1px] border-[#fff] grow-1 flex-grow" : "border-b-[1px] border-[#fff] grow-1 flex-grow"}></div>
                    </div>
                </div>
            );
        }
